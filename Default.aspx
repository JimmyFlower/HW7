...
<body>
    ...
    <div>
        ...
        <br />
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="UID" DataSourceID="SqlLFGDataSource">
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="UID" DataNavigateUrlFormatString="details.aspx?UID={0}" Text="View Details" />
            </Columns>
